...
import { StudioBridge } from './bridge/StudioBridge.js?orchestration=20260821-factory-identity-2';
...
class StakeStudio {
  ...
  async init() {
    ...
    const bootPanel = String(params.get('panel') || '').trim() || 'cabinet';
    ...
    try {
      ...
      this.activatePanel(bootPanel || 'cabinet');
    } catch {
